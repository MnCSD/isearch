...
export const CountrySelect = ({ country, onChange }: CountrySelectProps) => {
  return (
    <div className="relative w-[100%]  rounded-xl  h-[55px] flex items-center group">
      <select
        ...
        onChange={onChange}
        className={cn(
          "peer absolute pl-[6px] pt-4 w-full h-full rounded-xl bg-[#252527]/50 text-white focus:border-2 focus:border-[#0071E3] outline-none border-[#6E6E73] border z-[999]"
        )}
      >
      ...
      <label
        className={cn(
          ...
          country && "text-[13px] -translate-y-5 -translate-x-1"
        )}
      >
        Country
      </label>
